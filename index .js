Back
If you encounter errors while installing packages, ensure Node.js version is 20 (check settings).
If you get a "MODULE_NOT_FOUND" error, make sure the file name is entered correctly.
If the bot is slow, consider upgrading to 100% CPU and 1+GB RAM.
Deploy Panel
Click New File
Name it index.js as in the panel startup script.
Paste the code below and change SESSION_ID
Copy
const { spawnSync, spawn } = require('child_process')
const { existsSync, writeFileSync } = require('fs')
const path = require('path')

const SESSION_ID = // levanter_262a099e5cf6d84efd87960c8f6eeb3864 <- this symbol
